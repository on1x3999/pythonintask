...
print('Компьютер выбирает какое-либо слово и хаотично переставляет его буквы.Задача игрока - восстановить исходное слово')
print('За каждую подсказку программа списывает 5 баллов')
COUNT_INSIDE = 3

WORDS = ('игра','анаграмма', 'мышь', 'интернет', 'подсказка', 'интернет')
