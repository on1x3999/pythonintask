# Задача 9.
# игру, в которой компьютер выбирает какое-либо слово, а игрок должен
...
HANGMAN =("Умный", "не очень умный ", " не умный ", "ну прям очень вообще не умный", "ну прям очень вообще не умный")
