...
print(
"""
Вам будет доступно 30 пунктов, которые можно распределить между четырьмя характеристиками: Сила, Здоровье, Мудрость и Ловкость.
"""
)
oh=30
os=0
...
while otv=='да':
	while otv=='да':
		...
		if oh!=0:
			while True:
				otv=input('У вас остались нераспределенные ОХ. Нужно ли их распределить ещё? да/нет\n')
				if otv=='нет':
					break
				elif otv=='да':
					flagotv=True
