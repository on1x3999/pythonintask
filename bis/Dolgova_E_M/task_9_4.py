...
import random
WORDS=("ргсу","студентка","Долгова","анаграмма","март","пайтон","программирование", "корабль", "машина", "самолёт", "работа" )

HANGMAN =("Большая умница", "Умница", "Глупенький", "Все плохо", "Очень плохо")
